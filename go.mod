...
require (
	...
	github.com/giantswarm/appcatalog v0.2.7-0.20200722133540-11a29db78af8
...
replace (
	github.com/ghodss/yaml v0.0.0-20150909031657-73d445a93680 => github.com/ghodss/yaml v1.0.0
