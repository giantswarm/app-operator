...
replace (
	...
	// To fix CVE-2024-40635
	github.com/containerd/containerd v1.7.12 => github.com/containerd/containerd v1.7.27
...
replace github.com/klauspost/compress v1.18.0 => github.com/klauspost/compress v1.20.0
...
replace golang.org/x/crypto v0.55.0 => golang.org/x/crypto v0.56.0
