...
- Read `HelmRelease` dependencies via the `helm.toolkit.fluxcd.io/v2` API instead of the deprecated
  `v2beta2`. `v2` is the stable, storage version served by Flux 2.8.
