...
// Resource does garbage collection on the AppCatalog CR finalizers.
...
// EnsureCreated ensures that reconciled AppCatalog CR gets orphaned finalizer
// deleted.
func (r *Resource) EnsureCreated(ctx context.Context, obj interface{}) error {
	...
	if exists {
		r.logger.Debugf(ctx, "deleting legacy finalizer from appCatalog CR")
		...
		r.logger.Debugf(ctx, "deleted legacy finalizer from appCatalog CR")
		return nil
	}
